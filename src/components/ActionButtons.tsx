...
const Header: React.FC<HeaderProps> = ({ darkMode, walletActive }) => {
  ...
  return (
    <div style={{ backgroundColor: "#dc2626", color: "white", padding: "12px", textAlign: "center" }}>
      🔥 LIVE SUPRA BUILD 🔥
      {walletActive && (
        <div style={{ marginTop: "12px", display: "flex", justifyContent: "center", gap: "20px", alignItems: "center" }}>
